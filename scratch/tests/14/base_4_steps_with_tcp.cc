...
int main(int argc, char *argv[])
{
    ...
    sinkApp1.Get(1)->TraceConnectWithoutContext("Rx", MakeCallback(&RxPacketsTraceCubic));
    ...
    app4.Stop( Seconds(offset + 260));
    
    // 25%
    app3.Start(Seconds(offset + 260));
    app3.Stop( Seconds(g_simLength));
